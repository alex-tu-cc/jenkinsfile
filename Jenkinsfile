...
./copy-package \\$(cat /tmp/src-pkg-list | xargs) --from="ppa:oem-taipei-bot/ubuntu/checkbox-snapshot-staging" --from-suit=focal --to="ppa:oem-solutions-engineers/ubuntu/checkbox-snapshot" --to-suite=focal -b -y --skip-missing
EOF
