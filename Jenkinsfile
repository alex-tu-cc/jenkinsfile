                    ...
                    if ( "${SKIP_BUILD_IMG}" != "true" ){
                        ...
                        build job: 'sanity-3-testflinger-dell-bto-focal-fossa-990000-00001-staging',
                            parameters: [[$class: 'StringParameterValue', name: 'IMAGE_NO', value: "${IMAGE_NO}"],
                                    [$class: 'StringParameterValue', name: 'EXCLUDE_TASK', value: ".*miscellanea/debsums .*somerville/platform-meta-test .*miscellanea/screen-pkg-not-public .*misc/generic/grub_boothole"],
